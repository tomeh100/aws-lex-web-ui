...
methods: {
  ...
  openLanguageSelector() {
    ...
    onLanguageChange(newLanguage) {
      ...
      this.$store.dispatch('postTextMessage', this.messageForChangeLanguage(newLanguage))
    },
  ...
  messageForEndChatContent() {
    return {
      text: this.translations[this.currentLanguage].endChat.messageContent || 'End Chat',
      type: 'human',
    };
  },
},
